...
export interface ApiMarcaMarca extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    nombre: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    paisOrigen: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiModeloModelo extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Modelos de veh\u00EDculos';
    displayName: 'Modelo';
    pluralName: 'modelos';
    singularName: 'modelo';
  };
  ...
  attributes: {
    anoLanzamiento: Schema.Attribute.Integer & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    versiones: Schema.Attribute.Relation<'oneToMany', 'api::version.version'>;
  };
}
...
export interface ApiVersionVersion extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Versiones de modelos de veh\u00EDculos';
    displayName: 'Version';
  ...
  attributes: {
    ...
    nombre: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    transmision: Schema.Attribute.Enumeration<
